...
package de.dertak.opennms.restprovisioning.helper;
 ...
 */
public class SpreadsheetLayouterTest {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(SpreadsheetLayouterTest.class);
    ...
    @Test
    public void testLayoutGeneratedOdsFile() {
    }
